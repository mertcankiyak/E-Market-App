...
class HomeProductCell: UICollectionViewCell {
    ...
    func configure(with product: ProductModelElement, isFavorite: Bool) {
        configure(name: product.name, price: product.price, isFavorite: isFavorite, imageURL: product.image)
    }
    ...
    public func configure(productName: String, price: String) {
